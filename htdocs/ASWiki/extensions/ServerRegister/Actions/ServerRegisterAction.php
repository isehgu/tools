<?php
/**
 * ServerRegisterAction abstract class.
 */
abstract class ServerRegisterAction extends ArrayObject
{
	/**
	 * Action name.
	 * @var string
	...
	/**
	 * Instance of ServerRegisterConfig.
	 * @var ServerRegisterConfig
	 */
	...
	/**
	 * Instances of ServerRegisterModel
	 * @var ServerRegisterModel
	 */
	 ...
	 * 
	 * @param ServerRegisterConfig
	 * @return void
	 */
	public function setConfig(ServerRegisterConfig $config)
	{		
		$this->_config = $config;
	}
	 ...
	 * @param ServerRegisterModel $obj
	 */
	public function setModel(ServerRegisterModel $obj, $key = 'default')
	{
