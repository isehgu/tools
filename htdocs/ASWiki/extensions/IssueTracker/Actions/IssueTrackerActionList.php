...
{	
	...
	public function listAction()
	{
		...
		if ($this->filterBy !== null || $this->filterStatus !== null) {
			...
			if ($this->filterApplication !== null) {
				if (array_key_exists($this->filterApplication, $this->issueApplication)) {
					$conds['application'] = $this->filterApplication; 
				} 
			}
			
			if ($this->filterType !== null) {
				if (array_key_exists($this->filterType, $this->issueType)) {
					$conds['type'] = $this->filterType; 
				} 
			}
	...
	protected function _setDefaultVars()
	{
		...
		$this->issueApplication      = $this->_config->getIssueApplication();
