 ...
 * @subpackage Skins
 */
class SkinvbGORE extends SkinTemplate {
	/** Using vbGORE. */
	function initPage( &$out ) {
		SkinTemplate::initPage( $out );
		$this->skinname  = 'vbGORE';
		$this->stylename = 'vbGORE';
		$this->template  = 'vbGORETemplate';
	}
}
 ...
 * @subpackage Skins
 */
class vbGORETemplate extends QuickTemplate {
	/**
	 * Template filter callback for vbGORE skin.
...
$this->text('jsmimetype') ?>" src="<?php $this->text('jsvarurl'  )
?>"></script><?php } ?>
...
<div class="portlet" id="p-logo">
	...
	<?php } ?>
	  ...
	  <?php if($this->data['numberofwatchingusers' ]) { ?><?php  $this->html('numberofwatchingusers') ?><?php } ?>
		<br>
		<!-- do not remove this link please! thanks! :) -->
		<a href="www.vbgore.com">Skin by vbGORE - Free MMORPG Maker</a>
	</td>
      </div>
    </div>
