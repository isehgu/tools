...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php $this->text('lang') ?>" lang="<?php $this->text('lang') ?>" dir="<?php $this->text('dir') ?>">
	<head>
		...
		<link href="skins/roundedsassy/main.css" rel="stylesheet" type="text/css" />
...
<?php if($this->data['body_onload'    ]) { ?>onload="<?php     $this->text('body_onload')     ?>"<?php } ?>
 class="<?php $this->text('nsclass') ?> <?php $this->text('dir') ?>">
	...
	<div id="masthead">
	<h1>Rounded Sassy Edition MediaWiki Skin</h1>
...
<?php			} ?>
	...
	<div class="portlet" id="p-logo">
		<a style="background-image: url(skins/roundedsassy/wiki.png);" <?php
			?>href="<?php echo htmlspecialchars($this->data['nav_urls']['mainpage']['href'])?>" <?php
			?>title="<?php $this->msg('mainpage') ?>"></a>
	</div><!--//p-logo -->
<div class="sideitem-yel">
<div class="boxhead-yel">
	<div class='portlet' id='p-<?php echo htmlspecialchars($bar) ?>'>
		<div class="headfill">
		<h5><?php $out = wfMsg( $bar ); if (wfEmptyMsg($bar, $out)) echo $bar; else echo $out; ?></h5>
		</div><!--//headfill -->
		<div class="boxbody-yel">
		<div class='pBody'>
			<ul>
...
<div id="p-search" class="portlet">
		...
		<div id="searchBody" class="pBody">
			<form action="<?php $this->text('searchaction') ?>" id="searchform"><div>
				<img src="skins/roundedsassy/magnifyingglass.gif" alt="search" /><input id="searchInput" name="search" type="text" <?php
					if($this->haveMsg('accesskey-search')) {
						?>accesskey="<?php $this->msg('accesskey-search') ?>"<?php }
					if( isset( $this->data['search'] ) ) {
						?> value="<?php $this->text('search') ?>"<?php } ?> />
				<input type='image' name="go" class="searchButton" id="searchGoButton"	value="<?php $this->msg('go') ?>" src="skins/roundedsassy/go.gif" alt="go" title="go" />&nbsp;
				<input type='image' name="fulltext" class="searchButton" value="<?php $this->msg('search') ?>" src="skins/roundedsassy/search.gif" alt="search" title="search" />
			</div>
			</form>
		</div><!--//searchBody -->
	</div><!--//p-search -->
<div class="sideitem-green">
...
<?php
$sid="538295";
include("/home/jenny_jenny/RoundedSassy.com/analysis/write_logs.php");
?>
</div>
</body></html>
<?php
