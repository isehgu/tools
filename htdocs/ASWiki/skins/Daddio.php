 ...
 class="mediawiki <?php $this->text('nsclass') ?> <?php $this->text('dir') ?> <?php $this->text('pageclass') ?>">
	...
	<div class="portlet" id="p-cactions">
      <h5><?php $this->msg('views') ?></h5>
		<div class="pBody">
			<ul>
				<li id="firstHeading"><?php $this->data['displaytitle']!=""?$this->html('title'):$this->text('title') ?></li>
...
<?php 			foreach($cont as $key => $val) { ?>
				<p id="<?php echo Sanitizer::escapeId($val['id']) ?>"<?php
					if ( $val['active'] ) { ?> class="active" <?php }
				?>><a href="<?php echo htmlspecialchars($val['href']) ?>"<?php echo $skin->tooltipAndAccesskey($val['id']) ?>><?php echo htmlspecialchars($val['text']) ?></a></p>
<?php			} ?>
			</ul>
		</div><!-- pBody -->
	</div><!-- portlet -->
	...
	<div class="portlet" id="p-search">
      <div class="searchbox">
      <h4><label for="searchInput"><?php $this->msg('search') ?></label></h4>
      </div>
...
<?php
		if($this->data['notspecialpage']) { ?>
				<p id="t-whatlinkshere"><a href="<?php
				echo htmlspecialchars($this->data['nav_urls']['whatlinkshere']['href'])
				?>"<?php echo $skin->tooltipAndAccesskey('t-whatlinkshere') ?>><?php $this->msg('whatlinkshere') ?></a></p>
<?php
			if( $this->data['nav_urls']['recentchangeslinked'] ) { ?>
				<p id="t-recentchangeslinked"><a href="<?php
				echo htmlspecialchars($this->data['nav_urls']['recentchangeslinked']['href'])
				?>"<?php echo $skin->tooltipAndAccesskey('t-recentchangeslinked') ?>><?php $this->msg('recentchangeslinked') ?></a></p>
<?php 		}
		}
		if(isset($this->data['nav_urls']['trackbacklink'])) { ?>
			<p id="t-trackbacklink"><a href="<?php
				echo htmlspecialchars($this->data['nav_urls']['trackbacklink']['href'])
				?>"<?php echo $skin->tooltipAndAccesskey('t-trackbacklink') ?>><?php $this->msg('trackbacklink') ?></a></p>
<?php 	}
		if($this->data['feeds']) { ?>
			<p id="feedlinks"><?php foreach($this->data['feeds'] as $key => $feed) {
		...
		foreach( array('contributions', 'log', 'blockip', 'emailuser', 'upload', 'specialpages') as $special ) {
			...
			if($this->data['nav_urls'][$special]) {
				?><p id="t-<?php echo $special ?>"><a href="<?php echo htmlspecialchars($this->data['nav_urls'][$special]['href'])
				?>"<?php echo $skin->tooltipAndAccesskey('t-'.$special) ?>><?php $this->msg($special) ?></a></p>
<?php		}
		}

		if(!empty($this->data['nav_urls']['print']['href'])) { ?>
				<p id="t-print"><a href="<?php echo htmlspecialchars($this->data['nav_urls']['print']['href'])
				?>"<?php echo $skin->tooltipAndAccesskey('t-print') ?>><?php $this->msg('printableversion') ?></a></p><?php
		}

		if(!empty($this->data['nav_urls']['permalink']['href'])) { ?>
				<p id="t-permalink"><a href="<?php echo htmlspecialchars($this->data['nav_urls']['permalink']['href'])
				?>"<?php echo $skin->tooltipAndAccesskey('t-permalink') ?>><?php $this->msg('permalink') ?></a></p><?php
		} elseif ($this->data['nav_urls']['permalink']['href'] === '') { ?>
				<p id="t-ispermalink"<?php echo $skin->tooltip('t-ispermalink') ?>><?php $this->msg('permalink') ?></p><?php
		}
?>
			</ul>
		</div><!-- pBody -->
