 ...
 * @subpackage Skins
 */
class Skinkindofblue extends SkinTemplate {
	/** Using kindofblue. */
	function initPage( &$out ) {
		SkinTemplate::initPage( $out );
		$this->skinname  = 'kindofblue';
		$this->stylename = 'kindofblue';
		$this->template  = 'kindofblueTemplate';
	}
}
 ...
 * @subpackage Skins
 */
class kindofblueTemplate extends QuickTemplate {
	/**
