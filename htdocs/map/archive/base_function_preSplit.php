...
/*
  ...
  */
    ...
    {
        $last_event_id_file = 'CACHE_last_event_id_from_db.dat';
        $displayHistoryByRelease_contents_file = 'CACHE_displayHistoryByRelease_contents.out';
        $last_event_id_from_db   = f_get_last_event_id_from_db();
        $last_event_id_from_file = f_get_last_event_id_from_file($last_event_id_file);
        $last_event_id_from_db   = intval($last_event_id_from_db);
        $last_event_id_from_file = intval($last_event_id_from_file);
        ...
        if($last_event_id_from_db > $last_event_id_from_file){
            ...
            if( file_exists($displayHistoryByRelease_contents_file) ){
                echo file_get_contents($displayHistoryByRelease_contents_file);
                return;
            }
        }
        ...
        $f_displayHistoryByRelease_contents = ob_get_contents();
        file_put_contents($displayHistoryByRelease_contents_file, $f_displayHistoryByRelease_contents);
    }
