		...
		<div class="row">
			<div class="col-sm-3 col-md-2 sidebar">
				...
				<ul class="nav nav-sidebar">
					<li><a id="test_selection_link" class="sidelink" href="#test_selection">Test Selection <span id="test_stat" class="badge pull-right"><?php echo f_statCount('test');?></span></a></li>
					<li><a id="progress_link" class="sidelink" href="#progress">Tests in Progress <span id="progress_stat" class="badge pull-right"><?php echo f_statCount('progress');?></span></a></li>
					<li><a id="queue_link" class="sidelink" href="#queue">Tests in Queue <span id="queue_stat" class="badge pull-right"><?php echo f_statCount('queue');?></span></a></li>
					<li><a id="history_link"class="sidelink" href="#history">Test History <span id="history_stat" class="badge pull-right">200</span></a></li>
					<li><a id="history_complete_link"class="sidelink" href="history_complete.php" target="_blank">Complete History <span id="history_stat" class="badge pull-right"><?php echo f_statCount('history');?></span></a></li>
					<li><a id="env_link" class="sidelink" href="#env">Environment Settings <span id="env_stat" class="badge pull-right"><?php echo f_statCount('env');?></span></a></li>
					<li><a id="upgrade_link"href="upgrade.php" target="_blank">Environment Upgrade</a></li>
					<li><a id="tac_stats_link" href="tac_stats.php" target="_blank">Accolades</a></li>
					<li><a id="isxfiles_link"href="http://ic-aoc01/isxfiles/" target="_blank">Release Register</a></li>
					<li><a id="keyword_link"href="http://asg.ise.com/tap/ASG_Library_Keywords_Docs.html" target="_blank">Keyword Docs</a></li>
		...
		<div id="main" class="col-sm-9 col-sm-offset-3 col-md10 col-md-offset-2">
			...
			<div id="history">
				...
				<table class="table">
					<thead>
						<tr>
							<th id='th_header'>Test Status</th>
							<th>Report</th>
							<th>Env</th>
							<th id='th_header'>Request ID</th>
							<th>Label</th>
							<th>Test Name</th>
							<th>Start Time</th>
							<th>End Time</th>
