    ...
    while($row = $result->fetch_assoc())
      ...
      $comment_count = f_getCommentCount($rid);
			...
			echo "				
							...
							<td class='test_clickable time_display'>$stime</td>
							<td class='test_clickable time_display'>$etime</td>

			";

            $report_class = '';
            if($status == 2) $report_class = 'report_button_passed';
            elseif($status == 3) $report_class = 'report_button_failed';
			...
			else
			{
                ...
                echo "<td><div>
                            <div class='tap_report'>
                                <a title='Click for TAP (Robot Framework) Report' href='$report' target='_blank' class='btn btn-xs $report_class'>
                                    &nbsp;Report&nbsp;
                                </a>
                            </div>";
                if($tfpath != '')
                {
                    ...
                    echo "<div class='result_files'>
                              <a title='Click to see any result files' href='$tfpath' target='_blank' class='btn btn-xs results_button'>Results</a>
                          </div></div></td>";
                }
                else
                {
                    echo "<div class='result_files ' title='No Results are available'>
                          <a title='No Results are available' href='$tfpath' target='_blank' class='btn btn-xs results_button_disabled disabled'>&nbsp;&nbsp;None&nbsp;&nbsp;</a>
                          </div>
                          </div></td>";
                }
			}
