			...
			else
			{
                ...
                echo "<td><div>
                            <div class='tap_report'>
                                <a title='Click for TAP (Robot Framework) Report' href='$report' target='_blank' class='btn btn-xs btn-primary'>
                                    &nbsp;Report&nbsp;
                                </a>
                            </div>";
                if($tfpath != '')
                {
                    ...
                    echo "<div class='result_files'>
                              <a title='Click to see any result files' href='$tfpath' target='_blank' class='btn btn-xs btn-primary'>Results</a>
                          </div></div></td>";
                }
                else
                {
                    echo "<div class='result_files ' title='No Results are available'>
                          <a title='No Results are available' href='$tfpath' target='_blank' class='btn btn-xs btn-primary disabled'>Results</a>
                          </div>
                          </div></td>";
                }
			}
